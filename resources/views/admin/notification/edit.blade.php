	...
	<!-- BEGIN CONTENT -->
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">{{ trans('titles.edit_notification') }}</a>
					</li>
				</ul>
				...
				<div class="col-md-12 ">
					...
					<div class="portlet light bordered">
						...
						<div class="portlet-body form">
							<form  id="formNotification" method="post"  action="/notification/{{$notification->id}}">
								{{ csrf_field() }}
								...
								<div class="form-actions noborder">
									<a onclick="postDatos('notification', 'formNotification')">
									<button type="button" class="btn btn-circle blue">{{trans('forms.update')}}</button>
									</a>

									<a onclick="cargarDatos('notification')">
