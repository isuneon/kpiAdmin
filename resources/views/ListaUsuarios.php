			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					...
					<ul class="dropdown-menu dropdown-menu-default">
						...
						<li>
							<a href="inbox.html">
							<i class="icon-envelope-open"></i> Mi Bandeja de Entrada <span class="badge badge-danger">
							3 </span>
							</a>
						</li>
						<li>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Lista de Usuarios <small>Lista de usuarios registrados en el sistema</small>
			</h3>
			<div class="page-bar">
			...
			<div class="row">
				<div class="col-md-12">
                  ...
                  Admin
								...
								<td>
                  <div align="center"><a href="#">Editar</a> / <a href="#">Eliminar</a></div>
								</td>
							</tr>
